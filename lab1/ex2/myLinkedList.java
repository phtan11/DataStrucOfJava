...
public class myLinkedList <E> implements ListInterface <E> {
    ...
    public Node <E> currentNode(E item){
        Node<E> tmp = head;
        while(tmp.getNext() != null){
            if(tmp.getData().equals(item)){
                break;
    ...
    public Node<E> previousNode(E item){
        Node<E> pre = null;
        Node<E> tmp = head;
        while(tmp.getNext() != null){
            if(tmp.getData().equals(item)){
    ...
    @Override
    public E removeCurr(Node <E> curr, Node<E> previous) throws NoSuchElementException{
        if (head == null) {
            throw new NoSuchElementException("cant not");
        } else {
